...
import { Breadcrumb, SentryBreadcrumbHint, SentryEvent, SentryEventHint, SentryResponse, Severity } from '@sentry/types';
...
export declare abstract class BaseClient<B extends Backend, O extends Options> implements Client<O> {
     ...
     * @inheritDoc
     */
    addBreadcrumb(breadcrumb: Breadcrumb, hint?: SentryBreadcrumbHint, scope?: Scope): Promise<void>;
    /**
     * @inheritDoc
     */
